...
public class Menutab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.getTabAt(0).setIcon(R.drawable.ensalada);
        tabLayout.getTabAt(1).setIcon(R.drawable.atleta);
        tabLayout.getTabAt(2).setIcon(R.drawable.cardiograma);
//        tabLayout.getTabAt(3).setIcon(R.mipmap.ic_gymbrowser);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_menutab, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_menutab, container, false);
...
//                    return "SECTION 1";
                case 1:
                    DiaRutinaFragment diaRutinaFragment = new DiaRutinaFragment();
                    return diaRutinaFragment;
//                    return "SECTION 2";
                case 2:
