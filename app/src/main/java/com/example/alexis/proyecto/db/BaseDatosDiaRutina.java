 ...
 */
public class BaseDatosDiaRutina extends SQLiteOpenHelper {

    private Context context;

    public BaseDatosDiaRutina(Context context) {
    ...
    public ArrayList<DiaRutina> obtenerTodosLosDiasRutina() {
        ArrayList<DiaRutina> diaRutinas = new ArrayList<>();
        ...
        while (registros.moveToNext()){
            DiaRutina contactoActual = new DiaRutina();
