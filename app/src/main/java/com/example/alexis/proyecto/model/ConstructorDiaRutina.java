...
import com.example.alexis.proyecto.db.BaseDatosDiaRutina;
...
public class ConstructorDiaRutina {
    ...
    public ConstructorDiaRutina(Context context) {
        this.context = context;
    }

    public ArrayList<DiaRutina> obtenerDatos() {
        BaseDatosDiaRutina db = new BaseDatosDiaRutina(context);
//        insertarTresDietas(db);
        return  db.obtenerTodosLosDiasRutina();
    }
