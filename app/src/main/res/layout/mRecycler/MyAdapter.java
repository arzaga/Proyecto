...
public class MyAdapter extends RecyclerView.Adapter<MyHolder> {
    ...
    public void onBindViewHolder(MyHolder holder, int position) {
        ...
        holder.setItemClickListener(new com.tutorials.hp.masterdetailrecyclerview.mRecycler.ItemClickListener() {
            @Override
    ...
    {
        Intent i=new Intent(c, com.tutorials.hp.masterdetailrecyclerview.mDetail.DetailActivity.class);
